...
namespace BookBazaar.DataAccess.Migrations
{
    ...
    [Migration("20250201043701_changedNameOfOrderDetail")]
    partial class changedNameOfOrderDetail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookBazaar.Model.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookBazaar.Model.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookBazaar.Model.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookBazaar.Model.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookBazaar.Model.OrderDetail", b =>
                {
                    ...
                    b.HasOne("BookBazaar.Model.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("BookBazaar.Model.OrderHeader", b =>
                {
                    b.HasOne("BookBazaar.Model.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BookBazaar.Model.Product", b =>
                {
                    b.HasOne("BookBazaar.Model.Category", "Category")
                        .WithMany()
